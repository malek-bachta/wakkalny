		...
		<div class="wrap clearfix">
			...
			<nav class="main-nav" role="navigation" id="menu">
				<ul>
                    ...
                    <li class="current-menu-item"><a href="addcommande.html" title="Recipes"><span>Commande</span></a>
					<ul>
							<li><a href="liste_commande.php" title="Blog post">List commande</a></li>
						</ul>
					</li>
				</ul>
			</nav>
				...
				<section class="content center full-width">
					<div class="modal container">
						<form name="my form " method="post" action="" >
							...
							<div class="f-row">
								<input type="text" placeholder="Product name" name="product_name" id="poduct_name" />
							</div>
							<div class="f-row">
							...
							<div class="f-row">
								<input type="text" placeholder="Adress" name="adresse" id="adresse" />
							</div>
                            <div class="f-row">
								<input type="tel" placeholder="Phone number" name="phone" id="phone"  maxlength="8" />
							</div>
