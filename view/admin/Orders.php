                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="Orders.php" class="waves-effect"><i class="fa  fa-money fa-fw"
                                    ...
                                    <li><a href="cmdback.php" class="waves-effect"><i class="fa   fa-reorder (alias) fa-fw"
                                    aria-hidden="true"></i><span class="hide-menu">Ordes</span></li></a>
                                    </ul>
                        </li>
                        <li>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <form action="cmdback.php" method="post">
                    <label for=""> Code:</label> <input type="text" name="code"><br>
                    <label for=""> Pourcentage: </label><input type="number" name="pourcentage"><br>
                    <input type="submit">
                    </form>
                                        </tfoot>
                                    </table>
