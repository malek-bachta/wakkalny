            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-4 col-xs-12">
                        <div class="white-box">
                            <div class="user-bg"> <img width="100%" alt="user" src="plugins/images/large/1.jpg">
                                <div class="overlay-box">
                                    <div class="user-content">
                                        <a href="javascript:void(0)"><img src="plugins/images/users/<?php echo $user['image']; ?>"
                        ...
                        <div class="white-box">
                            <form class="form-horizontal form-material" method="post" action="updateprofile.php">
                                <div class="form-group">
                                    <label class="col-md-12">Full Name : <?php echo $user['nom'].' '.$user['prenom'] ;?></label>
                                   
                                </div>
                                <div class="form-group">
                                    <label for="example-email" class="col-md-12">Email : <?php echo $user['email']; ?></label>
                                    
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Password : <?php echo $user['mdp']; ?></label>
                                    
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Adress : <?php echo $user['adresse']; ?></label>
                                    
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Phone Number : <?php echo $user['tel']; ?></label>
                                    
                                
                                </div>
                                <div class="form-group">
                                <div class="f-row bwrap">
										<a href="updateprofile.php?id=<?php echo $_SESSION['username'];?>"><button>Edit Profile</button></a>
									</div>
                                </div>
                            </form>
                        </div>
