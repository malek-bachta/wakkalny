            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Purchased products</h4>
                    </div>
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        <ol class="breadcrumb">
                            <li><a href="#">Dashboard</a></li>
                            <li><a href="cmdback.php">Orders</a></li>
                            <li class="active">Purchased products</li>
                        </ol>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
...
foreach($listecmd as $row){
	...
	?>
	<tr>
			<td><?PHP echo $prodd['id']; ?></td>
	<td><?PHP echo $prodd['nom']; ?></td>
	<td><?PHP echo $prodd['prix']; ?></td>
	<td><?PHP echo $row['qty']; ?></td>
	<td><?PHP echo (int)$prodd['prix']*(int)$row['qty']; ?></td>
